...
@register_collator("qwen2_5-omni-7b")
class Qwen2_5Omni7BDataCollator(BaseDataCollator):
    ...
    def __call__(self, messages: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        if len(messages[0]) == 3: ### (audio, text, tag-mask) ###
        ...
        # Calculate category_size AFTER removing the mask

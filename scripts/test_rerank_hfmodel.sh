...
# RETRIEVAL_ROOT=${RETRIEVAL_ROOT:-/home/jilan_xu/AuroLA/hf_export/AuroLA-7B/downstream}
RETRIEVAL_ROOT=${RETRIEVAL_ROOT:-/home/jilan_xu/AuroLA/hf_export/AuroLA-3B/downstream}

# Rerank model checkpoint, here the original_model_name_or_path should be the same
# RERANK_MODEL_NAME_OR_PATH=${RERANK_MODEL_NAME_OR_PATH:-/home/jilan_xu/AuroLA/hf_export/AuroLA-rerank-7B}
RERANK_MODEL_NAME_OR_PATH=${RERANK_MODEL_NAME_OR_PATH:-/home/jilan_xu/AuroLA/hf_export/AuroLA-rerank-3B}
...
torchrun \
  ...
  --original_model_name_or_path "${RERANK_MODEL_NAME_OR_PATH}" \

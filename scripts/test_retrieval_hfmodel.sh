...
# MODEL_NAME_OR_PATH=${MODEL_NAME_OR_PATH:-/home/jilan_xu/AuroLA/hf_export/AuroLA-3B}
MODEL_NAME_OR_PATH=${MODEL_NAME_OR_PATH:-/home/jilan_xu/AuroLA/hf_export/AuroLA-7B}
OUTPUT_DIR=${OUTPUT_DIR:-${MODEL_NAME_OR_PATH}/downstream}

# Dataset paths are passed directly via env vars.
